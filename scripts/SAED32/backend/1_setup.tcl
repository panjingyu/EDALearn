...
create_library_set -name slow -timing [list $slow_lib ]
create_library_set -name typical -timing [list $typical_lib ]
create_library_set -name fast -timing [list $fast_lib ]

create_rc_corner -name default -qx_tech_file $qrc_tech_file
...
# init_design -setup normal -hold normal
setDesignMode -flowEffort $env(design_flow_effort) -powerEffort $env(design_power_effort) -process 32
